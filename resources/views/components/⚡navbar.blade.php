    ...
    <div class="px-6 mx-auto">
        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center space-x-4">
                ...
                @else
                    <a href="/login" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">Entrar</a>
                    <a href="/register" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">Registrar</a>
                @endif
            </div>
        </div>
    </div>
